...
export class SLAViolatedEvent {
  ...
  _validate() {
    if (!this.conversationId) {
      throw new Error('SLAViolatedEvent: conversationId is required');
    }
    if (!this.customerId) {
      throw new Error('SLAViolatedEvent: customerId is required');
    }
    if (!this.violationType) {
      throw new Error('SLAViolatedEvent: violationType is required');
    }
    if (this.expectedTime === undefined || this.expectedTime === null) {
      throw new Error('SLAViolatedEvent: expectedTime is required');
    }
    if (this.actualTime === undefined || this.actualTime === null) {
      throw new Error('SLAViolatedEvent: actualTime is required');
    }
    if (!this.severity) {
      throw new Error('SLAViolatedEvent: severity is required');
    }
  }
  ...
  static fromJSON(json) {
    return new SLAViolatedEvent(json);
  }
}
