...
import { slaCalculator, CustomerLevelCalculatorService } from '@domain/conversation/services/CustomerLevelCalculatorService';

describe('CustomerLevelCalculatorService', () => {
  ...
  it('should detect approaching deadlines', () => {
    const service = new CustomerLevelCalculatorService(20);
